                            ...
                            <tbody>
                                {data.map(dispositivo => (
                                    <tr key={dispositivo._id}>
                                        ...
                                        <td>{dispositivo.temperatura}</td>
                                        <td>{dispositivo.humedadRelativa}</td>
                                        <td>{dispositivo.humedadSuelo}</td>
                                        <td>{dispositivo.luminosidad}</td>
                                        <td>{dispositivo.bomba}</td>
                                        <td>{dispositivo.luces}</td>
                                        <td>{dispositivo.turbinas}</td>
